...
- (void)addMonthlyCalendar {
    ...
    MEMonthSelection *monthlSelection = [[MEMonthSelection alloc] initWithFrame:scrollFrame];
    [monthlSelection selectMonth:currentMonth];
    [self addSubview:monthlSelection];
    [monthlSelection release];
}
